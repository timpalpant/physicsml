...
class CuEquivarianceConfig:
    ...
    optimize_spherical_harmonics: bool = False
...
default_cueq_config = CuEquivarianceConfig(
    enabled=True,
    group="O3_e3nn",
    optimize_all=True,
)
    ...
    def __new__(
        ...
        if (
            ...
            def cuet_forward(
                ...
                index_attrs = torch.nonzero(attrs[:, :num_elements])[:, 1].int()
...
class SphericalHarmonics:
    """Wrapper around o3.SphericalHarmonics/cuet.SphericalHarmonics"""
